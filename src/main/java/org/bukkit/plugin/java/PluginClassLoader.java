...
public final class PluginClassLoader extends URLClassLoader {
    ...
    public PluginClassLoader(final JavaPluginLoader loader, @Nullable final ClassLoader parent, @NotNull final PluginDescriptionFile description, @NotNull final File dataFolder, @NotNull final File file, @Nullable ClassLoader libraryLoader) throws IOException, InvalidPluginException, MalformedURLException {
    ...
    Class<?> loadClass0(@NotNull String name, boolean resolve, boolean checkGlobal, boolean checkLibraries) throws ClassNotFoundException {
        ...
        if (checkGlobal) {
            ...
            Class<?> result = getClassByName(name, resolve, description);
                ...
                if (result.getClassLoader() instanceof PluginClassLoader) {
                    ...
                    if (provider != description
                        ...
                        if (plugin != null) {
                            ...
                            MockingbirdServer.getLogger().log(Level.WARNING, "[{0}] Loaded class {1} from {2} which is not a depend or softdepend of this plugin.", new Object[]{description.getName(), name, provider.getFullName()});
                        }
                    }
                }
    ...
    synchronized void initialize(@NotNull JavaPlugin javaPlugin) {
        ...
        javaPlugin.init(new JavaPluginLoader(null), loader.server, description, dataFolder, file, this);
    }
